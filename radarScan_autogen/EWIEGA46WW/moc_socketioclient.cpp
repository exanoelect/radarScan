...
template <> constexpr inline auto SocketIOClient::qt_create_metaobjectdata<qt_meta_tag_ZN14SocketIOClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const QString &, const QJsonValue &)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
        ...
        QtMocHelpers::SlotData<void(QAbstractSocket::SocketError)>(28, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 29, 7 },
        }}),
        // Slot 'sendPing'
...
void SocketIOClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->screenBrightnessSet((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 6: _t->volumeSet((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 7: _t->deviceOffRequested(); break;
        case 8: _t->deviceResetRequested(); break;
        case 9: _t->deviceRestartRequested(); break;
        case 10: _t->pingDeviceUp(); break;
        case 11: _t->helpEvent((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 12: _t->okEvent((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 13: _t->notOkEvent((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 14: _t->onWebSocketConnected(); break;
        case 15: _t->onWebSocketDisconnected(); break;
        case 16: _t->onWebSocketTextMessage((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 17: _t->onWebSocketError((*reinterpret_cast<std::add_pointer_t<QAbstractSocket::SocketError>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)(const QString & )>(_a, &SocketIOClient::connected, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)()>(_a, &SocketIOClient::deviceready, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)()>(_a, &SocketIOClient::disconnected, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)(const QString & )>(_a, &SocketIOClient::connectionError, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)(const QString & , const QJsonValue & )>(_a, &SocketIOClient::eventReceived, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)(int )>(_a, &SocketIOClient::screenBrightnessSet, 5))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)(int )>(_a, &SocketIOClient::volumeSet, 6))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)()>(_a, &SocketIOClient::deviceOffRequested, 7))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)()>(_a, &SocketIOClient::deviceResetRequested, 8))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)()>(_a, &SocketIOClient::deviceRestartRequested, 9))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)()>(_a, &SocketIOClient::pingDeviceUp, 10))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)(const QString & )>(_a, &SocketIOClient::helpEvent, 11))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)(const QString & )>(_a, &SocketIOClient::okEvent, 12))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)(const QString & )>(_a, &SocketIOClient::notOkEvent, 13))
            return;
    }
}
