...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lBrightness->setGeometry(QRect(270, 60, 57, 31));
        lBrightness->setFrameShape(QFrame::Shape::Box);
        hsBrightness = new QSlider(tab_7);
        hsBrightness->setObjectName("hsBrightness");
        hsBrightness->setGeometry(QRect(10, 70, 251, 16));
        hsBrightness->setValue(90);
        ...
        hsVol->setGeometry(QRect(10, 210, 251, 16));
        hsVol->setValue(90);
        hsVol->setOrientation(Qt::Orientation::Horizontal);
        lVol = new QLabel(tab_7);
        lVol->setObjectName("lVol");
        lVol->setGeometry(QRect(270, 210, 57, 31));
        lVol->setFrameShape(QFrame::Shape::Box);
        ...
        labelGetVolRequest->setFrameShape(QFrame::Shape::Box);
        ...
        labelGetBrightnessRequest->setFrameShape(QFrame::Shape::Box);
