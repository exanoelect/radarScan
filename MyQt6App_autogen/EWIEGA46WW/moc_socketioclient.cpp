...
void SocketIOClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->eventReceived((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QJsonValue>>(_a[2]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)(const QString & )>(_a, &SocketIOClient::connectionError, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)(const QString & , const QJsonValue & )>(_a, &SocketIOClient::eventReceived, 3))
            return;
