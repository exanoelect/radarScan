...
template <> constexpr inline auto SocketIOClient::qt_create_metaobjectdata<qt_meta_tag_ZN14SocketIOClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'eventReceived'
        QtMocHelpers::SignalData<void(const QString &, const QJsonValue &)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 8 }, { 0x80000000 | 10, 11 },
        }}),
...
void SocketIOClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)(const QString & )>(_a, &SocketIOClient::connectionError, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (SocketIOClient::*)(const QString & , const QString & )>(_a, &SocketIOClient::eventReceived, 3))
            return;
...
// SIGNAL 3
void SocketIOClient::eventReceived(const QString & _t1, const QString & _t2)
{
